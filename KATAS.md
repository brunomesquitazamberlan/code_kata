...
This index tracks the kata sequence, current status, and concepts practiced.
...
- `Ready`: challenge is written and ready for a first attempt.
- `In Progress`: first implementation is being written or reviewed.
